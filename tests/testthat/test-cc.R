...
test_that("gly_consensus_clustering works with different parameters", {
  ...
  result_max_k3 <- suppressMessages(gly_consensus_clustering(exp_subset, max_k = 3, reps = 30))
  result_max_k5 <- suppressMessages(gly_consensus_clustering(exp_subset, max_k = 5, reps = 30))
  ...
  result_km <- suppressMessages(gly_consensus_clustering(exp_subset, cluster_alg = "km", max_k = 3, reps = 30))
...
test_that("gly_consensus_clustering scale parameter works", {
  ...
  result_scaled <- suppressMessages(gly_consensus_clustering(exp_subset, scale = TRUE, max_k = 3, reps = 30))
  result_unscaled <- suppressMessages(gly_consensus_clustering(exp_subset, scale = FALSE, max_k = 3, reps = 30))
...
test_that("gly_consensus_clustering add_info parameter works", {
  ...
  result_no_info <- suppressMessages(gly_consensus_clustering(exp_subset, add_info = FALSE, max_k = 3, reps = 30))
...
test_that("gly_consensus_clustering output_file parameter works correctly", {
  ...
  withr::with_tempdir({
    suppressMessages({
      result1 <- gly_consensus_clustering_(expr_mat, max_k = 3, reps = 10, output_file = NULL)
    })
  ...
  withr::with_tempdir({
    ...
    suppressMessages({
      result2 <- gly_consensus_clustering_(expr_mat, max_k = 3, reps = 10, output_file = output_path)
    })
  ...
  withr::with_tempdir({
    ...
    suppressMessages({
      result3 <- gly_consensus_clustering_(expr_mat, max_k = 3, reps = 10, output_file = output_path)
    })
