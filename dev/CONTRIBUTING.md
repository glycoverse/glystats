...
This outlines how to propose a change to glystats. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("glycoverse/glystats", fork = TRUE)`.
...
Please note that the glystats project is released with a [Contributor
Code of
Conduct](https://glycoverse.github.io/glystats/dev/CODE_OF_CONDUCT.md).
