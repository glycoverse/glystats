...
* New `gly_correlated_sets()` constructs complete-linkage or connected correlated variable sets, and new `gly_set_test()` jointly tests independent or paired two-group shifts with Hotelling's T2 statistic.
